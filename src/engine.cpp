...
void Engine::createSwapchain() {
  const auto &caps = Engine::swapchain.supportDetails.capabilities;
  ...
  createInfo.imageFormat = Engine::swapchain.format.format;
  createInfo.imageColorSpace = Engine::swapchain.format.colorSpace;
